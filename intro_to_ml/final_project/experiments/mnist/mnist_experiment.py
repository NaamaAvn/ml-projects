...
def optimize_hyperparameters(X_train, y_train, X_val, y_val, max_trials=25):
    ...
    Args:
        ...
        X_val, y_val: Validation data (used for hyperparameter optimization)
    ...
    for trial_count, combo in enumerate(combinations, 1):
        ...
        try:
            ...
            # Update best configuration based on validation accuracy
...
def load_best_config():
    ...
    try:
        with open(latest_file, 'r') as f:
            ...
            print(f"Best validation accuracy: {data['best_config']['val_accuracy']:.4f}")
...
def main():
    """Main function to demonstrate the neural network on MNIST"""
    # Load MNIST data
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        if sys.argv[1] == "optimize":
            ...
            print("Usage:")
            print("  python mnist_experiment.py          # Run MNIST training")
            print("  python mnist_experiment.py optimize # Run MNIST optimization")
    else:
        main() 