...
def optimize_hyperparameters(X_train, y_train, X_val, y_val, max_trials=25):
    ...
    if best_config is None:
        print("ERROR: No successful trials completed. All trials failed.")
        print("Please check your data and neural network implementation.")
        return None, results
...
def load_best_config():
    ...
    results_dir = os.path.join(".", "outputs", "optimization_results")
    if not os.path.exists(results_dir):
